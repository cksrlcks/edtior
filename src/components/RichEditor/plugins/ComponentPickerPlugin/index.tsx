...
export function getBaseOptions(editor: LexicalEditor, showModal: ShowModal) {
  return [
    ...
    ...([1, 2, 3] as const).map(
      (n) =>
        new ComponentPickerOption(`제목 ${n}`, {
    ...
    new ComponentPickerOption('번호 매기기 목록', {
      icon: <i className="icon number" />,
      keywords: ['numbered list', 'ordered list', 'ol'],
      onSelect: () =>
        editor.dispatchCommand(INSERT_ORDERED_LIST_COMMAND, undefined),
    }),
    new ComponentPickerOption('글머리 기호 목록', {
      icon: <i className="icon bullet" />,
      keywords: ['bulleted list', 'unordered list', 'ul'],
      onSelect: () =>
        editor.dispatchCommand(INSERT_UNORDERED_LIST_COMMAND, undefined),
    }),
    new ComponentPickerOption('할 일 목록', {
      icon: <i className="icon check" />,
      keywords: ['check list', 'todo list'],
      onSelect: () =>
        editor.dispatchCommand(INSERT_CHECK_LIST_COMMAND, undefined),
    }),
    new ComponentPickerOption('인용', {
    ...
    new ComponentPickerOption('코드블록', {
    ...
    ...(['left', 'center', 'right', 'justify'] as const).map(
      (alignment) =>
        new ComponentPickerOption(`${ALIGN_MAP[alignment]} 정렬`, {
