    ...
    >
      ...
      >
        <div className="icon-text-container">
          ...
          <span className="text">번호 매기기 목록</span>
        </div>
      ...
      >
        <div className="icon-text-container">
          ...
          <span className="text">글머리 기호 목록</span>
        </div>
      ...
      >
        <div className="icon-text-container">
          ...
          <span className="text">할 일 목록</span>
        </div>
      ...
      >
        <div className="icon-text-container">
          ...
          <span className="text">코드 블록</span>
        </div>
    ...
    >
      ...
      >
        <div className="icon-text-container">
          ...
          <span className="text">우측 정렬</span>
        </div>
            ...
            >
              ...
              >
                <div className="icon-text-container">
                  ...
                  <span className="text">첫 글자 대문자</span>
                </div>
              ...
              >
                <div className="icon-text-container">
                  ...
                  <span className="text">하이라이트</span>
                </div>
              </DropDownItem>
              <DropDownItem
                onClick={(e) =>
              ...
              >
                <div className="icon-text-container">
                  ...
                  <span className="text">서식 지우기</span>
                </div>
